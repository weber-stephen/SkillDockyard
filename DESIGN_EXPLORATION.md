...
Operational, robust, candid, technical, high-accountability, and utilitarian.
...
- Densified tables and added numbered labels to mobile data records.
...
The review spotlight has the strongest visual weight on the dashboard. Metrics read as a single operational unit. Mobile tables become numbered field records, retaining every data point without horizontal scrolling. Existing navigation and workflows remain unchanged.

## Tradeoffs

This direction optimizes for clarity, durability, and high-information environments. It is intentionally less soft and less conventionally premium; the uppercase display voice can feel forceful in low-stakes contexts.

## Further Work

If selected, the next pass should apply the numbered manual pattern to review history, create print-ready review summaries, and add compact density controls for teams with hundreds of skills.
